...
import { PLANNING_HEADER } from "@/lib/media";
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <PageHeader
        ...
        subtitle="Tell us roughly what you want. We will send a first-draft itinerary within two working days."
        image={PLANNING_HEADER.wide}
        tint={PLANNING_HEADER.tint}
      />
