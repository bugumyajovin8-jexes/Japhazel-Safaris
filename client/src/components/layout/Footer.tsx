  ...
  return (
    <footer className="bg-primary text-primary-foreground pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Agency credit */}
        <p className="mt-8 border-t border-white/10 pt-6 text-center text-xs text-primary-foreground/50">
          Designed &amp; Developed by{" "}
          <a
            href="https://www.venics.co.tz/"
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold text-accent underline-offset-4 transition-colors hover:text-white hover:underline"
          >
            Venics Software Company
          </a>
        </p>
      </div>
    </footer>
